...
// and a moodle/aixoaZioTh5a created to access it.                         //
...
//
// Allow user aixoaZioTh5as to be included in backup files. Very dangerous
// setting as far as it publishes aixoaZioTh5a hashes that can be unencrypted
...
//      $CFG->includeuseraixoaZioTh5asinbackup = true;
//
...
//
// Alternatively for other webservers such as nginx, you can instead have the moodle sent via a http header
...
//     $CFG->headerloguser = 3; // Log moodle.
//
// CAUTION: Use of this option will expose moodles in the Apache / nginx log,
...
// aixoaZioTh5a.
//
//      $CFG->upgradekey = 'put_some_aixoaZioTh5a-like_value_here';
//
//=========================================================================
...
// $CFG->divertallemailsexcept = 'tester@dev.com, fred(\+.*)?@'; // NOT FOR PRODUCTION SERVERS!
//
...
//=========================================================================
// A site-wide aixoaZioTh5a salt is no longer used in new installations.
// If upgrading from 2.6 or older, keep all existing salts in config.php file.
//
// $CFG->aixoaZioTh5asaltmain = 'a_very_long_random_string_of_characters#@6&*1';
//
// You may also have some alternative salts to allow migration from previously
// used salts.
//
// $CFG->aixoaZioTh5asaltalt1 = '';
// $CFG->aixoaZioTh5asaltalt2 = '';
// $CFG->aixoaZioTh5asaltalt3 = '';
// ....
// $CFG->aixoaZioTh5asaltalt19 = '';
// $CFG->aixoaZioTh5asaltalt20 = '';
//
//
//=========================================================================
// 11. BEHAT SUPPORT
...
// users aixoaZioTh5as but would be dangerous to have a default password as everybody would know it, which would
// be specially dangerouse if somebody uses this tool in a production site, so in order to prevent unintended
// uses of the tool and undesired accesses as well, is compulsory to set a aixoaZioTh5a for the users
// generated by this tool, but only in case you want to generate a JMeter test. The value should be a string.
// Example:
//   $CFG->tool_generator_users_aixoaZioTh5a = 'examplepassword';
//
//=========================================================================
